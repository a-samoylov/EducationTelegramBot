...
class MessageEntity
{
     ...
     */
    public function getUser(): \App\Service\Telegram\Model\Type\Base\User
    {
        return $this->user;
    }

    /**
     * @param \App\Service\Telegram\Model\Type\Base\User $user
     */
    public function setUser(\App\Service\Telegram\Model\Type\Base\User $user): void
    {
        $this->user = $user;
    }
