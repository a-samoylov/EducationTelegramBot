...
class Message
{
    ...
    public function __construct(
        int $messageId,
        \App\Service\Telegram\Model\Type\User $from,
        \DateTime $date,
        \App\Service\Telegram\Model\Type\Chat $chat,
        \App\Service\Telegram\Model\Type\User $forwardFrom,
        \App\Service\Telegram\Model\Type\Chat $forwardFromChat,
        int $forwardFromMessageId,
        string $forwardSignature,
        \DateTime $forwardDate,
        \App\Service\Telegram\Model\Type\Message $replyToMessage,
        \DateTime $editDate,
        int $mediaGroupId,
        ...
        \App\Service\Telegram\Model\Type\Audio $audio,
        \App\Service\Telegram\Model\Type\Document $document,
        \App\Service\Telegram\Model\Type\Animation $animation,
        \App\Service\Telegram\Model\Type\Game $game,
        array $photo,
        \App\Service\Telegram\Model\Type\Sticker $sticker,
        \App\Service\Telegram\Model\Type\Video $video,
        \App\Service\Telegram\Model\Type\Voice $voice,
        \App\Service\Telegram\Model\Type\VoiceNote $voiceNote,
        string $caption,
        \App\Service\Telegram\Model\Type\Contact $contact,
        \App\Service\Telegram\Model\Type\Location $location,
        \App\Service\Telegram\Model\Type\Venue $venue,
        \App\Service\Telegram\Model\Type\User $newChatMember,
        \App\Service\Telegram\Model\Type\User $leftChatMember,
        string $newChatTitle,
        array $newChatPhoto,
        ...
        \App\Service\Telegram\Model\Type\Message $pinnedMessage,
        \App\Service\Telegram\Model\Type\Invoice $invoice,
        \App\Service\Telegram\Model\Type\SuccessfulPayment $successfulPayment,
        string $connectedWebsite,
        \App\Service\Telegram\Model\Type\PassportData $passportData
    ) {
